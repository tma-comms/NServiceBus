    ...
    class Receiving : Feature
    {
        internal Receiving()
        {
            ...
            Defaults(s =>
            {
                ...
                var mainLogicalAddress = new LogicalAddress(baseQueueName, null, mainInstance.Properties);
                ...
                {
                    var instanceSpecificAddress = transportInfrastructure.ToTransportAddress(mainLogicalAddress.CreateIndividualized(discriminator));
