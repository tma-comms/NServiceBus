namespace NServiceBus.Features
{
    ...
    public class TimeoutManager : Feature
    {
        ...
        {
            var satelliteLogicalAddress = context.Settings.LogicalAddress().CreateSubscope("TimeoutsDispatcher");
        ...
        {
            var satelliteLogicalAddress = context.Settings.LogicalAddress().CreateSubscope("Timeouts");
            var satelliteAddress = context.Settings.GetTransportAddress(satelliteLogicalAddress);
