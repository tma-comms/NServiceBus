namespace NServiceBus
{
    ...
    public static class MsmqConfigurationExtensions
    {
        ...
        /// <param name="scope">The scope of the given distribution strategy.</param>
        public static void SetMessageDistributionStrategy(this RoutingSettings<MsmqTransport> config, DistributionStrategy distributionStrategy, DistributionStrategyScope scope)
        {
            config.Settings.GetOrCreate<DistributionPolicy>().SetDistributionStrategy(distributionStrategy, scope);
        }
